...
namespace _BaseY.Utils
{
    ...
    {
        public static Vector2 NaNVector2
        {
        ...
        public static float SignedAngle(Vector3 a, Vector3 b, Vector3 axis)
        {
            a.Normalize();
            b.Normalize();
            return Mathf.Acos(Mathf.Clamp(Vector3.Dot(a, b), -1f, 1f)) * MathUtil.RAD_TO_DEG *
                   Mathf.Sign(Vector3.Dot(axis, Vector3.Cross(a, b)));
        }
        ...
        /// <param name="bUseRadians"></param>
        /// <returns></returns>
        public static Vector3 RotateAroundAxis(Vector3 v, float a, Vector3 axis, bool clockwise = false,
