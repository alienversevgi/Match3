...
namespace UnityTimer
{
    ...
    public class Timer
    {
        ...
        public TimerCounting Counting { get; set; } = TimerCounting.Down;
        ...
        public static Timer Register(float duration, TimerCounting counting, Action onComplete, Action<float> onUpdate = null,
            bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
        {
            ...
            Timer timer = new Timer(duration,counting, onComplete, onUpdate, isLooped, useRealTime, autoDestroyOwner);
        ...
        private Timer(float duration,TimerCounting counting, Action onComplete, Action<float> onUpdate,
        ...
        private void Update()
        {
            ...
            if (this._onUpdate != null)
            {
                switch (Counting)
                {
                    case TimerCounting.Up:
                        this._onUpdate(this.GetTimeElapsed());
                        break;
                    case TimerCounting.Down:
                        this._onUpdate(this.GetTimeRemaining());
                        break;
                }
            }
